...
function vhost(opt) {
    ...
    function strip(moved) {
        return function(req, res, next) {
            return redirect(res, moved, req.headers.host, req.url) ? void 0 : next();
        };
    }
    function proxies(domain, moved, proxy) {
        ...
        if (moved) {
            ...
            return function(req, res, next) {
                ...
                return domainC.test(host) ? (proxyC.web(req, res), !0) : rdc(res, mvd, host, req.url) ? !0 : next();
            };
        }
        return function(req, res, next) {
            var host = req.headers.host;
            return domainC.test(host) ? (proxyC.web(req, res), !0) : next();
        };
    }
    function framework(domain, moved, fw) {
        ...
        if (moved) {
            ...
            return function(req, res, next) {
                var host = req.headers.host;
                return domainC.test(host) ? (fwC(req, res), !0) : rdc(res, mvd, host, req.url) ? !0 : next();
            };
        }
        return function(req, res, next) {
            var host = req.headers.host;
            return domainC.test(host) ? (fwC(req, res), !0) : next();
        };
    }
