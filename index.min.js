...
function vhost(opt) {
    ...
    function redirect_body(code) {
        ...
        return function(res, moved, host, url) {
            for (var reg = moved.reg, i = 0, ii = reg.length; ii > i; i++) if (reg[i].test(host)) {
                ...
                return setHeader(res, "Location", to, !0), res.writeHead(cod, {
                    Location: to
                }), res.end(), !0;
            }
            return !1;
    ...
    function strip(moved) {
        return function(req, res, next) {
            redirect(res, moved, req.headers.host, req.url) || end(next);
        };
    }
    function proxies(domain, moved, proxy) {
        ...
        if (moved) {
            ...
            return function(req, res, next) {
                ...
                return domainC.test(host) ? (proxyC.web(req, res), !0) : rdc(res, mvd, host, req.url) ? !0 : end(next);
            };
        }
        return function(req, res, next) {
            var host = req.headers.host;
            return domainC.test(host) ? (proxyC.web(req, res), !0) : end(next);
        };
    }
    function framework(domain, moved, fw) {
        ...
        if (moved) {
            ...
            return function(req, res, next) {
                var host = req.headers.host;
                return domainC.test(host) ? (fwC(req, res), !0) : rdc(res, mvd, host, req.url) ? !0 : end(next);
            };
        }
        return function(req, res, next) {
            var host = req.headers.host;
            return domainC.test(host) ? (fwC(req, res), !0) : end(next);
        };
    }
